...
class modal_dialog_plugin {
        ...
        <tr>
            ...
            <td>
                <select name="popupscript" id="popupscript" style="width:250px;">
                    <option value="colorbox"<?php if ( ( isset( $genoptions['popupscript'] ) && $genoptions['popupscript'] == 'colorbox') || !isset( $genoptions['popupscript'] ) ) { echo ' selected="selected"';} ?>>Colorbox</option>
                    <option value="fancybox"<?php if ( isset( $genoptions['popupscript'] ) && $genoptions['popupscript'] == 'fancybox') { echo ' selected="selected"';} ?>>Fancybox (legacy)</option>
                </select>
            </td>
        </tr>
	</table>
	...
	?>
			...
			<tr>
				...
				<td><TEXTAREA id="dialogtext" NAME="dialogtext" COLS=50 ROWS=10><?php echo esc_html(stripslashes($options['dialogtext'])); ?></TEXTAREA>
				</td>
			</tr>
			<tr>
            ...
            <tr>
				<td colspan="2"><input type="button" id="deletecookies" name="deletecookies" value="Delete All Cookies" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="pages" name="pages" size="50" value="<?php echo $options['pages']; ?>"/></td>
			</tr>
			<tr>
				<td>Pages and posts not to display dialog on</td>
				<td><input type="text" id="excludepages" name="excludepages" size="50" value="<?php echo $options['excludepages']; ?>"/></td>
			</tr>            
			<tr>
    ...
    function dialog_config_faq_meta_box() { ?>
        ...
        <p>Add the onclick property to your link or button code and call the <code>modal_dialog_open()</code> function.</p>

        <p><code>&lt;a href=&quot;#&quot; onclick=&quot;modal_dialog_open();&quot; title=&quot;Learn More&quot;&gt;Learn More&lt;/a&gt;</code></p>
        ...
        <p><code>&lt;a href=&quot;#&quot; onclick=&quot;modal_dialog_close();&quot; title=&quot;Close dialog&quot;&gt;Learn More&lt;/a&gt;</code></p>
	...
	function modal_dialog_admin_header( $dialogname = "MD_PP1" ) {
        ...
        if ( isset( $genoptions['popupscript'] ) && $genoptions['popupscript'] == 'fancybox' ) {
            ...
            ?>
            <style type="text/css">
                #cboxOverlay{ background:repeat 0 0 <?php echo $options['overlaycolor']; ?>; }
            </style>
        <?php }
	}
